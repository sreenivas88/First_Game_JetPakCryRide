...
# ifdef __APPLE__
	...
	std::string vertShaderSrc = loadShaderSrc("../src/vertex.shader");
	...
	std::string fragShaderSrc = loadShaderSrc("../src/fragment.shader");
	...
	fragShaderSrc = loadShaderSrc("../src/fragment.shader");
