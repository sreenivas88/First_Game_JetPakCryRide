...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// accerlation motion of player equation
		...
		trans = glm::translate(trans, glm::vec3(trans_x ,0 ,0));
        trans = glm::translate(trans, glm::vec3( 0,trans_y,0));
        trans = glm::translate(trans, glm::vec3(0 ,0,trans_z ));
